class Admin::ReservationsController < Admin::BaseController
  ...
  def index
    ...
    @reservations = @q.result.capacity_desc.page(params[:page])
  end
  ...
  def update
    Reservation.transaction do
      ...
      @reservation.vacancy?                                                     # 席数が0以外になった場合にcapacityステータスを空席に変更する。
  ...
  def reservation_params
    params.require(:reservation).permit(:name, :email, :phonenumber, :number_of_people, :visiting_time, :reservation_status, :capacity_id, :user_id, :reservation_media, :remarks)
  end
end
